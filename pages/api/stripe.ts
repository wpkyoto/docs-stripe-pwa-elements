...
type NextAPIHandler<Body = any> = (req: NextApiRequest) => Promise<Response<Body>>
 ...
 */
const createPaymentIntent:NextAPIHandler<CreatePaymentIntentResponse> = async (req) => {
 ...
 */
const createSetupIntent:NextAPIHandler<CreateSetupIntentResponse> = async (req) => {
 ...
 */
const createSubscription:NextAPIHandler<CreateSubscriptionResponse> = async () => {
